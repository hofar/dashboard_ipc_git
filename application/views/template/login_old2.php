            ...
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">
                    <div class="login-bg" style="background-image:url(../assets_login/pages/img/login/bg1.jpg)">
                        <img class="login-logo" src="<?php echo base_url(); ?>assets_login/pages/img/login/logo.png" /> </div>
                </div>
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        ...
                        <form action="<?php echo base_url('login'); ?>" class="login-form" method="post">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <input class="form-control form-control-solid placeholder-no-fix form-group" type="text" autocomplete="off" placeholder="Username" name="user_name" required/> </div>
                                <div class="col-xs-6">
                                    <input class="form-control form-control-solid placeholder-no-fix form-group" type="password" autocomplete="off" placeholder="Password" name="user_password" required/> </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Copyright &copy; Indonesia Port Corporation. 2018</p>
                                </div>
                            </div>
                        </div>
                    </div>
		    ...
		    return {
		        ...
		        init: function() {
		            ...
		            $('.login-bg').backstretch([
		                "<?php echo base_url(); ?>assets_login/pages/img/login/bg1.jpg",
		                "<?php echo base_url(); ?>assets_login/pages/img/login/bg2.jpg",
