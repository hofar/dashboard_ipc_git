                                ...
                                <div class="row invoice-logo">
                                    <div class="col-xs-12" style="text-align: center;">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <h4>
                                            List Program RKAP Investasi Berdasarkan Kendala <?php echo ($data2 == '0' ? 'Perusahaan Induk' : 'Anak Perusahaan'); ?>
                                            </h4>
                                        </div>
                                            ...
                                            <tbody>
                                               <?php foreach ($data as $row): ?>
                                                    <tr>
                                                        ...
                                                        <td align="center"><?php echo $row->REAL_SUBPRO_CONSTRAINTS; ?></td>
                                                        <td align="right">Rp.<?php echo number_format($row->RKAP_INVS_VALUE, 2, ',', '.') ?></td>
                                                        <td align="right">Rp.<?php echo number_format($row->REAL_SUBPRO_VAL, 2, ',', '.') ?></td>
                                                    </tr>
                                                <?php endforeach; ?> 
                                            </tbody>
                                        </table>
