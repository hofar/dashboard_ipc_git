    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1 style="color:#8f09b2;"><b>KURVA S SUB PROGRAM</b></h1>
            </div>
            <!-- END PAGE TITLE -->
        </div>
        <!-- END PAGE HEAD -->
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url(); ?>kurva/add/<?php echo $row_subprogram->RKAP_SUBPRO_ID ?>" style="color: #787305">Kurva S</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <p style="color:#4C4C4C">Form Kurva S Sub Program</p>
            </li>
        </ul>
                    ...
                    <form  id="addkurvas" class="form-horizontal" action="<?php echo base_url('kurva/added/' . $row_subprogram->RKAP_SUBPRO_ID . ''); ?>" method="post">
                                ...
                                <div class="the_kurva text-center">
                                    ...
                                    <div class="portlet-body">
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <div class="form-group" >
                                                <div class="col-sm-12">
                                                    <div class="leftstart col-sm-6">
                                                        <label class="tit-lbl lbl_start control-label col-sm-6">Start Date</label>
                                                        <div class="tgl-lbl col-sm-6">
                                                            <div class="form-group" style="margin: 0;">
                            ...
                            <div  style="overflow:auto;">
                                ...
                                <?php } else { ?> 
                                    <div class="text-center">
                                        ...
                                        <table>
                                            <?php                                                                                
                                            for ($j = 0; $j < count($resutl_all_month_non_adden_group); $j++) {
                                            ?>
                                            <tr>
                                            <!-- <div class="row"> -->
                                            <?php                                             
                                                 for ($i = 0; $i < count($resutl_all_month_adden1[$j]); $i++) {
                                             ?>
                                                <?php if ($resutl_all_month_adden1[$j][$i]->IS_ADDENDUM != $j): ?>
                                                ...
                                                <?php else: ?>
                                                    <td class="col-sm-1" style="margin: 3px !important; width:100px !important; padding-right: 1px !important; padding-left: 3px !important;">
                                                        <div class="input-group" style="margin-bottom: 5px;">                                    
                                                            <input type="hidden" name="SUBPRO_MON[]" value="<?php echo $resutl_all_month_adden1[$j][$i]->SUBPRO_MON ?>" class="form-control" style="width: 70;">
                                                            <?php if ($act == 'add'): ?>
                                                                <input class="form-control" type="text" name="kurva_value[]" value="<?php echo number_format($resutl_all_month_adden1[$j][$i]->SUBPRO_VALUE, 2, ',', '.') ?>" id="<?php echo $resutl_all_month_adden1[$j][$i]->SUBPRO_MON ?>" class="jumlah_persen" style="width: 70px;"/>
                                                            <?php elseif ($act == 'edit'): ?>
                                                                <input class="form-control" type="text" name="kurva_value[]" value="<?php echo ($list2->SUBPRO_VALUE == null) ? '' : number_format($list2->SUBPRO_VALUE, 2, ',', '.') ?>" id="<?php echo $resutl_all_month_adden1[$j][$i]->SUBPRO_MON ?>" class="jumlah_persen" style="width: 70px;" />
                                                            <?php endif ?>
                                                            <div class="input-group-addon">
                                                                %
                                                            </div>
                        ...
                        <div class="">
                            <?php if ($row_subprogram->IS_GANTTCHART == 0): ?>
                                <button type="submit" class="btn btn-success uppercase" id="button-add" disabled><div class="fa fa-plus"></div> SIMPAN</button>
                                &nbsp;
                                <a href="<?php echo base_url(); ?>subprogramrkapinvestasi/detail/<?php echo $row_subprogram->RKAP_SUBPRO_ID ?>" class="btn btn-default uppercase" ><div class="fa fa-ban"></div> CANCEL</a>
...
var dataAddendum = {
    label: "Addendum",
            data: [
<?php foreach ($cek_addendum as $rowdata): ?>
    <?= $rowdata->VALUE_ADDENDUM ?>,
<?php endforeach; ?>
            ],
...
var dataAddendum2 = {
    label: "",
            data: [
<?php foreach ($cek_addendum2 as $rowdata): ?>
    <?= $rowdata->VALUE_ADDENDUM ?>,
<?php endforeach; ?>
            ],
...
var dataAddendum3 = {
    label: "",
            data: [
<?php foreach ($cek_addendum3 as $rowdata): ?>
    <?= $rowdata->VALUE_ADDENDUM ?>,
<?php endforeach; ?>
            ],
...
var dataAddendum4 = {
    label: "",
            data: [
<?php foreach ($cek_addendum4 as $rowdata): ?>
    <?= $rowdata->VALUE_ADDENDUM ?>,
<?php endforeach; ?>
            ],
...
var dataAddendum5 = {
    label: "",
            data: [
<?php foreach ($cek_addendum5 as $rowdata): ?>
    <?= $rowdata->VALUE_ADDENDUM ?>,
<?php endforeach; ?>
            ],
...
<?php endforeach; ?>
    ...
    var speedData = {
    labels: [
<?php $no = 0; foreach ($cek_urutan as $rowdata): $no++;?>
    <?= $no; ?>,
<?php endforeach; ?>
    ],
            datasets: [dataFirst, dataSecond,dataAddendum, dataAddendum2, dataAddendum3, dataAddendum4, dataAddendum5 ]
    };
    var chartOptions = {
    legend: {
    display: true,
