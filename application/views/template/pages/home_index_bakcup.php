...
<div class="page-content-wrapper">
    <div class="page-content">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <?php if ($this->session->userdata('SESS_USER_PRIV') == 1): ?>
                    ...
                    <div class="col-sm-7">
                        <div class="form-group">
                          <!-- <button class="btn btn-success" onclick="induk($('#induk').val())">View</button> -->
                          <a href="<?php echo base_url(); ?>home/export_kpi_fisik" class="btn btn-danger fa fa-download" data-toggle="tooltip" title="Downlaod KPI Fisik"></a>
                          <a href="<?php echo base_url(); ?>home/export" class="btn btn-success fa fa-download" data-toggle="tooltip" title="Download KPI Program"></a>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <table class="table table-striped table-hover table-responsive green">
                <thead>
                    <tr>
                        <th rowspan="3" style="padding-bottom: 40px;">NO</th>
                        <th rowspan="3" style="padding-bottom: 40px;">CABANG PELABUHAN / UNIT</th>
                        <th colspan="8">KPI PROGRAM</th>
                        <th rowspan="3" style="padding-bottom: 40px;">% PROGRAM BERJALAN</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php foreach ($persentase_berjalan as $list):
                                if ($list->BRANCH_NAME == $row->BRANCH_NAME) {
                                    if ($list->PERSENTASE_BERJALAN > 0) {
                                            echo round($list->PERSENTASE_BERJALAN);
                                        }
                                    else{
                                           echo '0';
                                        }
            ...
            <table class="table table-striped table-hover table-responsive green">
                <thead>
                    <tr>
                        <th rowspan="3" style="padding-bottom: 40px;">NO</th>
                        <th rowspan="3" style="padding-bottom: 40px;">CABANG PELABUHAN / UNIT</th>
                        <th colspan="8">KPI REALISASI</th>
                        <th rowspan="3" style="padding-bottom: 40px;">% PERSENTASE</th>
                    </tr>
                    <tr>
                        <th colspan="4">REALISASI S/D BULAN BERJALAN</th>
                        <th colspan="4">TOTAL NILAI KONTRAK TAHUN BERJALAN</th>
                    </tr>
                    <tr>
                        <th>SIPIL</th>
                        <th>PERALATAN</th>
                ...
                <tfoot style="background-color: black; color: white;">
                    <tr style="text-align: center;">
                      <td colspan="2">JUMLAH</td>
                      <td>
                            <?php foreach ($jumlah_realisasi_sipil as $list):
                                if ($list->TOTAL_REALISASI > 0) {
                                        echo number_format($list->TOTAL_REALISASI, 2, ',', '.');
                                    }
                                else{
                                        echo '0';
                                    }
                      ...
                      <td>
                            <?php foreach ($jumlah_realisasi_peralatan as $list):
                                if ($list->TOTAL_REALISASI > 0) {
                                        echo number_format($list->TOTAL_REALISASI, 2, ',', '.');
                                    }
                                else{
                      ...
                      <td>
                            <?php foreach ($jumlah_realisasi_non_fisik as $list):
                                if ($list->TOTAL_REALISASI > 0) {
                                        echo number_format($list->TOTAL_REALISASI, 2, ',', '.');
                                    }
                                else{
                      ...
                      <td>
                            <?php foreach ($jumlah_realisasi_total_report as $list):
                                if ($list->TOTAL_REALISASI > 0) {
                                        echo number_format($list->TOTAL_REALISASI, 2, ',', '.');
                                    }
                                else{
                      ...
                      <td>
                            <?php foreach ($jumlah_kontrak_sipil as $list):
                                if ($list->TOTAL_NILAI_CONTRACT > 0) {
                                        echo number_format($list->TOTAL_NILAI_CONTRACT, 2, ',', '.');
                                    }
                                else{
                                        echo '0';
                                    }
                      ...
                      <td>
                            <?php foreach ($jumlah_kontrak_peralatan as $list):
                                if ($list->TOTAL_NILAI_CONTRACT > 0) {
                                        echo number_format($list->TOTAL_NILAI_CONTRACT, 2, ',', '.');
                                    }
                                else{
                      ...
                      <td>
                            <?php foreach ($jumlah_kontrak_non_fisik as $list):
                                if ($list->TOTAL_NILAI_CONTRACT > 0) {
                                        echo number_format($list->TOTAL_NILAI_CONTRACT, 2, ',', '.');
                                    }
                                else{
                      ...
                      <td>
                            <?php foreach ($jumlah_kontrak_total_report as $list):
                                if ($list->TOTAL_NILAI_CONTRACT > 0) {
                                        echo number_format($list->TOTAL_NILAI_CONTRACT, 2, ',', '.');
                                    }
                                else{
                      ...
                      <td>
                          <?php foreach ($fisik_persentase_footer as $list):
                                if ($list->PERSENTASE > 0) {
                                        echo round($list->PERSENTASE);
                                    }
                                else{
                                        echo '0';
                                    }
                ...
                <tbody style="text-align: center;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;"><?php echo $row->BRANCH_NAME; ?></td>
                        <td>
                            <?php foreach ($realisasi_sipil as $list):
                                if ($list->BRANCH_NAME == $row->BRANCH_NAME) {
                                    if ($list->TOTAL_REALISASI > 0) {
                                            echo number_format($list->TOTAL_REALISASI, 2, ',', '.');
                                        }
                        ...
                        <td>
                            <?php foreach ($realisasi_peralatan as $list):
                                if ($list->BRANCH_NAME == $row->BRANCH_NAME) {
                                    if ($list->TOTAL_REALISASI > 0) {
                                            echo number_format($list->TOTAL_REALISASI, 2, ',', '.');
                                        }
                        ...
                        <td>
                            <?php foreach ($realisasi_non_fisik as $list):
                                if ($list->BRANCH_NAME == $row->BRANCH_NAME) {
                                    if ($list->TOTAL_REALISASI > 0) {
                                            echo $list->TOTAL_REALISASI;
                                        }
                                    else{
                                           echo '0';
                                        }
                        ...
                        <td>
                            <?php foreach ($realisasi_total_report as $list):
                                if ($list->BRANCH_NAME == $row->BRANCH_NAME) {
                                    if ($list->TOTAL_REALISASI > 0) {
                                            echo number_format($list->TOTAL_REALISASI, 2, ',', '.');
                                        }
                        ...
                        <td>
                            <?php foreach ($kontrak_sipil as $list):
                                if ($list->BRANCH_NAME == $row->BRANCH_NAME) {
                                    if ($list->TOTAL_NILAI_CONTRACT > 0) {
                                            echo number_format($list->TOTAL_NILAI_CONTRACT, 2, ',', '.');
                                        }
                        ...
                        <td>
                            <?php foreach ($kontrak_peralatan as $list):
                                if ($list->BRANCH_NAME == $row->BRANCH_NAME) {
                                    if ($list->TOTAL_NILAI_CONTRACT > 0) {
                                            echo number_format($list->TOTAL_NILAI_CONTRACT, 2, ',', '.');
                                        }
                        ...
                        <td>
                            <?php foreach ($kontrak_non_fisik as $list):
                                if ($list->BRANCH_NAME == $row->BRANCH_NAME) {
                                    if ($list->TOTAL_NILAI_CONTRACT > 0) {
                                            echo number_format($list->TOTAL_NILAI_CONTRACT, 2, ',', '.');
                                        }
                        ...
                        <td>
                            <?php foreach ($kontrak_total_report as $list):
                                if ($list->BRANCH_NAME == $row->BRANCH_NAME) {
                                    if ($list->TOTAL_NILAI_CONTRACT > 0) {
                                            echo number_format($list->TOTAL_NILAI_CONTRACT, 2, ',', '.');
                                        }
                        ...
                        <td>
                            <?php foreach ($fisik_persentase as $list):
                                if ($list->BRANCH_NAME == $row->BRANCH_NAME) {
                                    if ($list->PERSENTASE > 0) {
                                            echo round($list->PERSENTASE);
                                        }
