         ...
         <div class="modal-dialog">
             <div class="modal-content">
                  <?php echo validation_errors(); ?>
                   <form method="post" id="modaleditsetting" action="<?php echo base_url(); ?>setting/update_status/<?php echo $list->CRITIC_ID; ?>">
...
<div class="modal fade modal-3d-slit modal-danger" id="hapus" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" id="modaldeletesetting" action="<?php echo base_url() ?>setting/delete/<?php echo $list->CRITIC_ID; ?>">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">×</span>
                    </button>
