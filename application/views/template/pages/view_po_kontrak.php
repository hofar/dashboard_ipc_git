...
<div class="page">
    <div class="page-content">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> PO Kontrak</li>
        </ol>
        <div class="headTab">
...
<script type="text/javascript">
    ...
    function w_o() {
        window.open("<?= site_url('rkapinvestasi/po_kontrak_list_sub') ?>", "_wd_po_k_l_s");
    }
